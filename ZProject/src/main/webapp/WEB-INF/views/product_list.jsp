						...
						<div class="row">
							<div class="col-lg-4 col-md-5">
								<div class="filter__sort">
									<span>정렬 기준</span> <select>
										<option value="1">정확성</option>
										<option value="2">낮은 가격순</option>
										<option value="3">높은 가격순</option>
										<option value="4">리뷰 많은순</option>
										<option value="5">평점 높은순</option>
									</select>
								</div>
							</div>
							...
							<div class="col-lg-4 col-md-3">
								<div class="filter__option">
									<span c lass="icon_grid-2x2"></span> <span class="icon_ul"></span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									...
									onclick="location.href='productDetails.do?pno=${product.pno }'">
								</div>
								<div class="product__item__text">
									<h6>
										<a href="productDetails.do?pno=${product.pno }">${product.pname }</a><!-- 메인컨트롤러에서  -->
									</h6>
