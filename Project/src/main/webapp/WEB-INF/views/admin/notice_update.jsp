						...
						<div class="card-body">
							...
							<form action="updateNotice.do" method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="nname" value="${dto.nname }">
										<input type="hidden" class="form-control" name="nno" value="${dto.nno }">
									</div>
								</div>
								<div class="row mb-3">
									<label class="col-sm-2 col-form-label">내용</label>
									<div class="col-sm-10" style="min-height: 100px;">
										<textarea class="form-control tinymce-editor" name="ncontent">${dto.ncontent }</textarea>
									</div>
								</div>
								<div class="row mb-3">
